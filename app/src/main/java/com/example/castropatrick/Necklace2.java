...
public class Necklace2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_necklace2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result.append("\nTotal Amount: ₱" + Final + " ");
                Toast.makeText(Necklace2.this, Result.toString(), Toast.LENGTH_SHORT).show();
