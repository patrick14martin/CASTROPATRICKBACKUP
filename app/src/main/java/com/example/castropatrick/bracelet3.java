...
public class bracelet3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bracelet3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result.append("\nTotal Amount: ₱" + Final + " ");
                Toast.makeText(bracelet3.this, Result.toString(), Toast.LENGTH_SHORT).show();
