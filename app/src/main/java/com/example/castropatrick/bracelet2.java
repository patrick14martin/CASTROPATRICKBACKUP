...
public class bracelet2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bracelet2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result.append("\nTotal Amount: ₱" + Final + " ");
                Toast.makeText(bracelet2.this, Result.toString(), Toast.LENGTH_SHORT).show();
